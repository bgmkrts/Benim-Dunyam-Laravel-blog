                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <input class="switch" category-id="{{$category->id}}" name="category-id" value="{{$category->id}}" type="checkbox" data-on="Aktif" data-off="Pasif" data-onstyle="success" data-offstyle="danger" @if($category->status==1) checked
