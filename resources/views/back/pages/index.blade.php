                    ...
                    <tr id="page_{{$page->id}}">
                      <td class="text-center" style="width: 3%">
                        ...
                        <td>
                            ...
                            <input class="switch" name="page-id" value="{{$page->id}}"
                                   type="checkbox" data-on="Aktif" data-off="Pasif" data-onstyle="success" data-offstyle="danger" @if($page->status==1) checked
